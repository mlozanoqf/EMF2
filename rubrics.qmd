...
This section provides the common rubric for the Oral component of homework assignments and partial exams. Each homework or exam question defines the specific requirements and evaluation criteria for its Written component. The Written component is graded according to those question-specific instructions and required outputs. Written work must also follow [Activity rules and consequences](course-policies.qmd#sec-ap).
...
**Applicability of criteria.** Not every criterion necessarily applies to every Oral component. When a criterion is not relevant because of the nature of the activity or selected question, it will be marked N/A and excluded from the calculation. The remaining applicable criteria will be weighted equally when calculating the Oral component mark. An N/A is not equivalent to zero.

| Criterion | No evidence or weak (0-10) | Emerging (11-17) | Competent (18-21) | Strong (22-25) |
|---|---|---|---|---|
| Understanding of the problem, objectives, or concepts (25 points) | Cannot explain the relevant problem, objectives, or concepts. | Shows limited or unclear understanding of the relevant elements. | Explains the relevant problem, objectives, or concepts with reasonable clarity. | Explains the relevant elements clearly, accurately, and thoughtfully. |
| Methodology or implementation (25 points) | Cannot explain the relevant methodology, code, or implementation. | Describes the relevant elements with limited understanding. | Explains the relevant methodology, code, or implementation with mostly correct reasoning. | Clearly justifies the relevant methodology or explains the code or implementation with confidence. |
| Results, interpretation, or limitations (25 points) | Cannot explain or interpret the relevant results, conclusions, or limitations. | Gives a superficial or partially incorrect account of the relevant elements. | Explains or interprets the relevant results, conclusions, or limitations with reasonable clarity. | Interprets the relevant elements clearly and precisely, including mistakes or possible improvements when applicable. |
